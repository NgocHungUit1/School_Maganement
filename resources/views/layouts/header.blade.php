<div class="header">
    ...
    <div class="header-left">
        ...
        @elseif (Auth::user()->user_type == 4)
            <a href="{{ url('parent/dashboard') }}" class="logo">
                <img src="/./assets/img/logo.png" alt="Logo">
            </a>
        @endif
    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item dropdown has-arrow new-user-menus">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="{{ url('profile/change-password') }}">My Profile</a>
    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu">
                    <a href="{{ url('admin/admin/list') }}"><i class="fas fa-user"></i> <span> User</span> <span
                            class="menu-arrow"></span></a>
                    <ul>
                ...
                <li class="submenu">
                    <a href="{{ url('admin/class/list') }}"><i class="fas fa-building"></i> <span> Class</span> <span
                            class="menu-arrow"></span></a>
                    <ul>
